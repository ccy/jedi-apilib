...
type
  IDropTarget = interface(IUnknown)
    ...
    function DragEnter(const dataObj: JwaWindows.IDataObject; grfKeyState: Longint;
      pt: TPoint; var dwEffect: Longint): HResult; stdcall;
    function DragOver(grfKeyState: Longint; pt: TPoint;
      var dwEffect: Longint): HResult; stdcall;
    function DragLeave: HResult; stdcall;
    function Drop(const dataObj: JwaWindows.IDataObject; grfKeyState: Longint; pt: TPoint;
      var dwEffect: Longint): HResult; stdcall;
  end;
...
procedure ReleaseStgMedium(var medium: JwaWindows.TStgMedium); stdcall; external 'ole32.dll';

{ TForm3 }


function TFormMain.DragEnter(const dataObj: JwaWindows.IDataObject; grfKeyState: Integer;
...
function TFormMain.Drop(const dataObj: JwaWindows.IDataObject; grfKeyState: Integer;
  pt: TPoint; var dwEffect: Integer): HResult;
var
