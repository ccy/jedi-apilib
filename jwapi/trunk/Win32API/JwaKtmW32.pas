...
function CommitTransaction; external KtmW32Lib name 'CommitTransaction';
function CommitTransactionAsync; external KtmW32Lib name 'CommitTransactionAsync';
function CopyFileTransactedA; external kernel32 name 'CopyFileTransactedA';
function CopyFileTransactedW; external kernel32 name 'CopyFileTransactedW';
function CopyFileTransacted; external kernel32 name 'CopyFileTransacted' + AWSuffix;
function CreateDirectoryTransactedA; external kernel32 name 'CreateDirectoryTransactedA';
function CreateDirectoryTransactedW; external kernel32 name 'CreateDirectoryTransactedW';
function CreateDirectoryTransacted; external kernel32 name 'CreateDirectoryTransacted' + AWSuffix;
function CreateFileTransactedA; external kernel32 name 'CreateFileTransactedA';
function CreateFileTransactedW; external kernel32 name 'CreateFileTransactedW';
function CreateFileTransacted; external kernel32 name 'CreateFileTransacted' + AWSuffix;
function CreateHardLinkTransactedA; external kernel32 name 'CreateHardLinkTransactedA';
function CreateHardLinkTransactedW; external kernel32 name 'CreateHardLinkTransactedW';
function CreateHardLinkTransacted; external kernel32 name 'CreateHardLinkTransacted' + AWSuffix;
function CreateSymbolicLinkTransactedA; external kernel32 name 'CreateSymbolicLinkTransactedA';
function CreateSymbolicLinkTransactedW; external kernel32 name 'CreateSymbolicLinkTransactedW';
function CreateSymbolicLinkTransacted; external kernel32 name 'CreateSymbolicLinkTransacted' + AWSuffix;
function CreateTransaction; external KtmW32Lib name 'CreateTransaction';
function DeleteFileTransactedA; external kernel32 name 'DeleteFileTransactedA';
function DeleteFileTransactedW; external kernel32 name 'DeleteFileTransactedW';
function DeleteFileTransacted; external kernel32 name 'DeleteFileTransacted' + AWSuffix;
function FindFirstFileNameTransactedW; external kernel32 name 'FindFirstFileNameTransactedW';
function FindFirstFileTransactedA; external kernel32 name 'FindFirstFileTransactedA';
function FindFirstFileTransactedW; external kernel32 name 'FindFirstFileTransactedW';
function FindFirstFileTransacted; external kernel32 name 'FindFirstFileTransacted' + AWSuffix;
function GetCompressedFileSizeTransactedA; external kernel32 name 'GetCompressedFileSizeTransactedA';
function GetCompressedFileSizeTransactedW; external kernel32 name 'GetCompressedFileSizeTransactedW';
function GetCompressedFileSizeTransacted; external kernel32 name 'GetCompressedFileSizeTransacted' + AWSuffix;
function GetFileAttributesTransactedA; external kernel32 name 'GetFileAttributesTransactedA';
function GetFileAttributesTransactedW; external kernel32 name 'GetFileAttributesTransactedW';
function GetFileAttributesTransacted; external kernel32 name 'GetFileAttributesTransacted' + AWSuffix;
function GetFullPathNameTransactedA; external kernel32 name 'GetFullPathNameTransactedA';
function GetFullPathNameTransactedW; external kernel32 name 'GetFullPathNameTransactedW';
function GetFullPathNameTransacted; external kernel32 name 'GetFullPathNameTransacted' + AWSuffix;
function GetLongPathNameTransactedA; external kernel32 name 'GetLongPathNameTransactedA';
function GetLongPathNameTransactedW; external kernel32 name 'GetLongPathNameTransactedW';
function GetLongPathNameTransacted; external kernel32 name 'GetLongPathNameTransacted' + AWSuffix;
function GetTransactionId; external KtmW32Lib name 'GetTransactionId';
function MoveFileTransactedA; external kernel32 name 'MoveFileTransactedA';
function MoveFileTransactedW; external kernel32 name 'MoveFileTransactedW';
function MoveFileTransacted; external kernel32 name 'MoveFileTransacted' + AWSuffix;
function OpenTransaction; external KtmW32Lib name 'OpenTransaction';
function RegCreateKeyTransactedA; external advapi32 name 'RegCreateKeyTransactedA';
function RegCreateKeyTransactedW; external advapi32 name 'RegCreateKeyTransactedW';
function RegCreateKeyTransacted; external advapi32 name 'RegCreateKeyTransacted' + AWSuffix;
function RegDeleteKeyTransactedA; external advapi32 name 'RegDeleteKeyTransactedA';
function RegDeleteKeyTransactedW; external advapi32 name 'RegDeleteKeyTransactedW';
function RegDeleteKeyTransacted; external advapi32 name 'RegDeleteKeyTransacted' + AWSuffix;
function RegOpenKeyTransactedA; external advapi32 name 'RegOpenKeyTransactedA';
function RegOpenKeyTransactedW; external advapi32 name 'RegOpenKeyTransactedW';
function RegOpenKeyTransacted; external advapi32 name 'RegOpenKeyTransacted' + AWSuffix;
function RemoveDirectoryTransactedA; external kernel32 name 'RemoveDirectoryTransactedA';
function RemoveDirectoryTransactedW; external kernel32 name 'RemoveDirectoryTransactedW';
function RemoveDirectoryTransacted; external kernel32 name 'RemoveDirectoryTransacted' + AWSuffix;
function RollbackTransaction; external KtmW32Lib name 'RollbackTransaction';
function RollbackTransactionAsync; external KtmW32Lib name 'RollbackTransactionAsync';
function SetFileAttributesTransactedA; external kernel32 name 'SetFileAttributesTransactedA';
function SetFileAttributesTransactedW; external kernel32 name 'SetFileAttributesTransactedW';
function SetFileAttributesTransacted; external kernel32 name 'SetFileAttributesTransacted' + AWSuffix;
