...
{$IFDEF WIN7_UP}
function SHGetKnownFolderIDList; external shell32 name 'SHGetKnownFolderIDList';
function SHSetKnownFolderPath; external shell32 name 'SHSetKnownFolderPath';
function SHGetKnownFolderPath; external shell32 name 'SHGetKnownFolderPath';
{$ENDIF WIN7_UP}
