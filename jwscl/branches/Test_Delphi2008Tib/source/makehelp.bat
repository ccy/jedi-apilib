...
REM Cache :  http://pasdoc.sipsolutions.net/CacheOption
REM delete pasdoc-Cache if parameter changes
REM pasdoc -v 6 %1 %2 -N "JWSCL Help" -T "JEDI Windows Security Code Library" --write-uses-list --introduction "..\documentation\introduction.txt" --conclusion "..\documentation\conclusion.txt" --auto-link -D PACKAGE_CONDITIONS;JWA_INCLUDE_SETUP_API;JWA_INCLUDE_JWAADSTLB;DYNAMIC_LINK -I ..\..\..\jwapi\trunk\Common -E .\pasdoc *.pas > _out.txt
