...
// PASTLWTR : 1.2
// Datei generiert am 14.03.2008 15:34:43 aus der unten beschriebenen Typbibliothek.
...
const
  ...
  JWSCLComTestsMajorVersion = 1;
  JWSCLComTestsMinorVersion = 0;

  LIBID_JWSCLComTests: TGUID = '{2B2A8966-CCBC-4251-9D94-335DADA66781}';
